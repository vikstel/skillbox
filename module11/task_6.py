...
# 40       104
# 50       122
down_board = int(input("Нижняя граница: "))
up_board = int(input("Верхняя граница: "))
step = int(input("Шаг: "))
print("C\t\t F")
for i in range(down_board, up_board + 1, step):
    print(i, "\t\t", int(32 + i * 1.8))
if up_board % step != 0:
    print(up_board, '\t\t', int(32 + up_board * 1.8))