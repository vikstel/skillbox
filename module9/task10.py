...
secret_word = input("Введите шифр: ")
first_half_word = ''
second_half_word = ''
for i, symbol in enumerate(secret_word, 1):
    if i % 2 == 1:
        first_half_word += symbol
    else:
        second_half_word = symbol + second_half_word
print("Расшифрованное слово:", first_half_word + second_half_word)
